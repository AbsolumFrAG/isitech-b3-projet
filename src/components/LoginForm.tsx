  ...
  return (
    <Container onSubmit={handleSubmit}>
      <LoginContainer>
        ...
        <Subheading>{"Nous sommes contents de vous revoir !"}</Subheading>
        ...
        <PasswordField>
          ...
          <Link href="/login" passHref>
            <Fine>
              <LinkText>Oublié votre mot de passe ?</LinkText>
            </Fine>
          </Link>
        </PasswordField>
      ...
      <BanterContainer onClick={guestLogin}>
        ...
        <SubCaption>
          ...
          <Bold>compte invité</Bold> instantanément.
        </SubCaption>
      </BanterContainer>
    </Container>
  );
