      ...
      <RegisterContainer>
        ...
        <UsernameField>
          ...
          <UsernameInput
            ...
            type="text"
            required
            placeholder="Comment devrait-on vous appeler ?"
        ...
        <PasswordField>
          <PasswordLabel htmlFor="passwordInput">Mot de passe</PasswordLabel>
        ...
        <ContinueButton type="submit" value="Continuer" />

        <Link href="/login" passHref>
          <LinkText>Vous avez déjà un compte ?</LinkText>
        </Link>

        <Fine>
          En vous inscrivant, vous vous engagez à respecter les autres et à ne
          pas intenter de procès. Disclown.
        </Fine>
      </RegisterContainer>
    </Container>
  );
